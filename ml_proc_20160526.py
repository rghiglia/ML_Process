...
# Not that easy ... you need to:
# 1) Define a list of buckets
# 2) Assign observations to bucket
# 3) Cross-tab multi-class by bucket
# 4) Do the stacked histogram
# Lot of work ... will skip for now

# Although some code is already in survival_stats, not stacked though
survival_stats(data_trn, y_trn, 'Age')
...
# I will code some generic functions like NaN to average, etc.
# Then I should probably have problem-dedicated functions, say nan_titanic, etc.
